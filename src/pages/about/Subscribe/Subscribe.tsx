...
import { useGetSubscribeQuery } from "../../../redux/features/about/aboutApi";
...
const Subscribe = () => {
    ...
    const { data: contact } = useGetSubscribeQuery({ page: currentPage, limit: pageSize })
    console.log('subscriber', contact?.data?.data);
    ...
    return (
        <div className="bg-white p-5 rounded-lg shadow-md mb-6">
            <div className="flex flex-col md:flex-row md:justify-between md:items-center mt-5">
                <h2 className="text-md md:text-xl font-semibold mb-5 md:mb-0 ">All Subscribers</h2>
            </div>
