...
import { useCreateEventsMutation } from "../../../../redux/features/events/eventsApi";
...
const NewEventModal = ({ isModalOpen, handleOk, handleCancel }: AddModalProps) => {
    ...
    return (
        <Modal centered footer={false} title="New Event" open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
            {contextHolder}
            <Form
                form={form}
