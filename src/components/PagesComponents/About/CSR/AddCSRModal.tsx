...
import { useCreateCSRMutation } from "../../../../redux/features/csr/csrApi";
...
const AddCSRModal = ({ isModalOpen, handleOk, handleCancel }: AddModalProps) => {
    const [api, contextHolder] = notification.useNotification();
    const [form] = Form.useForm();
    const [fileList, setFileList] = useState<any[]>([]);

    const [createCSR, { isLoading }] = useCreateCSRMutation();
    ...
    return (
        <Modal centered footer={false} title="Add CSR" open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
            {contextHolder}
            <Form
                form={form}
